    ...
    >
      <div className="flex flex-col items-center justify-start gap-10 p-4 rounded-2xl py-6 h-full">
        <div className="flex flex-col items-center justify-start gap-10">
          ...
          <Link to="/inicio-medico" className="text-3xl text-white cursor-pointer font-extrabold" title="Home" onClick={toggleSidebar}>
            <AiOutlineHome />
          </Link>
          <Link to="/agenda-pacientes" className="text-3xl text-white cursor-pointer font-extrabold" title="Agendamentos" onClick={toggleSidebar}>
            <AiOutlineCalendar />
          </Link>
          <Link to="/prontuarios-pacientes" className="text-3xl text-white cursor-pointer font-extrabold" title="Prontuário Médico" onClick={toggleSidebar}>
