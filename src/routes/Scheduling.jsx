...
const Scheduling = () => {
  return (
    ...
    <div>
      ...
      <h2 className="text-purple-400 font-bold text-3xl text-center md:text-left py-5">Suas Consultas</h2>
      ...
      <div className="flex flex-col items-center md:justify-normal justify-center sm:mt-10 mt-5 md:space-x-4 space-x-0 sm:flex-row sm:gap-0 gap-4">
       ...
       <div className="flex items-center justify-center h-[30vh]">
        <h1 className="text-purple-400 font-bold md:text-4xl text-2xl md:ml-[25%] ml-0">Nenhuma consulta marcada</h1>
        </div> 
